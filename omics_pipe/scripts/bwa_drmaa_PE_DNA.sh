...
####INPUTS: $1: BWA_RESULTS $2: TEMP_DIR $3 SAMTOOLS_VERSION $4 BWA_VERSION $5 BWA_INDEX $6 SAMPLE $7 RAW_DATA_DIR $8 BWA_OPTIONS $9 COMPRESSION
...
#create config file
if [ "$comp" = "GZIP" ]; then
	bwa mem $8 $5 $7/$6_1.fastq.gz $7/$6_2.fastq.gz > $1/$6/$6.sam
else
	bwa mem $8 $5 $7/$6_1.fastq $7/$6_2.fastq > $1/$6/$6.sam
fi
